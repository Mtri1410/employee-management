                ...
                <tr key={user.employeeId} className="hover:bg-slate-900/10 transition duration-150">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center font-bold text-slate-355">
                  ...
                  <td className="px-6 py-4 text-right space-x-2 text-nowrap">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 bg-slate-800 hover:bg-slate-750 text-slate-350 rounded-lg text-xs font-semibold transition border border-slate-700/80"
                    >
                      Điều chuyển
                    </button>
                  </td>
...
const newModalsBlock = `{/* Details & Contract Renewal Modal */}
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-4 text-xs">
                ...
                <div className="col-span-2 bg-slate-950/40 p-3 rounded-xl border border-slate-855 mt-2">
                  ...
                  {selectedUserForDetails.contractFile ? (
                    ...
                    <span className="text-xs text-slate-555 italic">Chưa tải lên file hợp đồng ký kết.</span>
                  )}
                </div>
              </div>
            )}
      ...
      {transferringUser && createPortal(
        <div className="fixed inset-0 bg-slate-955/65 backdrop-blur-[4px] flex items-center justify-center z-[9999] p-4 animate-in fade-in duration-200">
